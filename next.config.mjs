...
const nextConfig = {
	...
	// Rewrites for Matterport webpack chunk files
	async rewrites() {
		return [
			{
				// 해시된 showcase 파일명을 실제 showcase.js로 매핑
				source: "/matterport-assets/js/showcase.:hash.js",
				destination: "/matterport-assets/js/showcase.js",
			},
			{
				// 일반적인 해시 패턴도 처리
				source: "/matterport-assets/js/:filename.:hash.js",
				destination: "/matterport-assets/js/:filename.js",
			},
		];
	},
